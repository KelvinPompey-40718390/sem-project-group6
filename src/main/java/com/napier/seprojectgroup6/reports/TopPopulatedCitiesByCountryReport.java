...
public class TopPopulatedCitiesByCountryReport implements Report {
    ...
    public TopPopulatedCitiesByCountryReport() {
    ...
    public void runWithLimitAndCountry(Integer limit, String country ) {
        this.limit = limit;
    ...
    public void displayCities() {
        ...
        System.out.println("\nTop " + this.limit + " populated cities" + " in " + this.country);
